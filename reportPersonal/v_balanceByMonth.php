<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="mn_balanceByMonth" >Balance Report</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active mn_balanceByMonth">Balance Report</li>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <form method="get">
                        <input type="hidden" name="d" value="reportPersonal/balanceByMonth" />
                        <div class="row">
                        ...
                        <div class="box-footer">
                            <button type="reset" class="btn btn-default" onclick="document.location='?d=reportPersonal/balanceByMonth'">ຍົກເລີກ</button>
                                    ...
                                    <table id="example1" class="table table-bordered beautified_report">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="no" >no</th>
                                                <th class="id" >staffId</th>
                                                <th class="accountName" >AccountName</th>
                                                <th class="fullName" >FullName</th>
                                             
                                                <th class="gender" >gender</th>
                                                <th class="email" >emaillAddr</th>
                                                <th class="monthYear" >Month & Year</th>
                                                <th class="totalTopup" >totalTopup</th>
                                                <th class="totalPayment">totalPayment</th>
                                                <th class="totalBalance">totalBalance</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            $arr = balancePersonalWalletByMonth($tokenKey, $userName, $_GET['cb_month'], $_GET['cb_year'], $api_url);
                                            $i = 1;
                                            foreach ($arr as $data) {
                                            ?>
                                                <tr>
