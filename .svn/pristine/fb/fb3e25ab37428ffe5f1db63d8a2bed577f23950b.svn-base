...
function topupStaffAmount($tokenKey, $userName, $amount, $walletAccount,$topupMonth,$topupYear, $api_url)
{
    $message = '';
...
function refundStaffAmount($tokenKey, $userName, $amount, $walletAccount, $api_url)
{
    $message = '';
