                            ...
                            <form method="post" action="?d=wallet/topup" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="month" name="txtMonth" class="form-control"
                                                onchange="console.log(this.value)" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Amount</label>
                                            <input type="input" style="text-align: right; " placeholder="input amount:"
                                                Name="txtAmount" class="form-control number"
