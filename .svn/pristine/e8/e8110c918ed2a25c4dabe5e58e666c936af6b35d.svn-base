...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="mn_staffRefundWallet" >Staff Refund Wallet</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active mn_staffRefundWallet">Staff Refund Wallet</li>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-body">
                            <form method="post" action="?d=wallet/refund" enctype="multipart/form-data">
