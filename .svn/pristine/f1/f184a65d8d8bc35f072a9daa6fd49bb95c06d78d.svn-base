        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <form method="get">
                        <input type="hidden" name="d" value="reportPersonal/topupByMonth" />
                        <div class="row">
                        ...
                        <div class="box-footer">
                            <button type="reset" class="btn btn-default" onclick="document.location='?d=reportPersonal/topupByMonth'">ຍົກເລີກ</button>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="example1" class="table table-bordered beautified_report">
                                        ...
                                        <tbody>
                                            <?php
                                            $arr = topupPersonalWalletByMonth($tokenKey, $userName, $_GET['cb_month'], $_GET['cb_year'], $api_url);
                                            $i = 1;
                                            foreach ($arr as $data) {
                                            ?>
                                                <tr>
