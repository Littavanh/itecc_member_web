              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="index.php?d=report/payment" class="nav-link <?= $mn_paymentReport ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Payment By Diary</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="index.php?d=report/topupByMonth" class="nav-link <?= $mn_topupByMonthReport ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>TopUp By Month</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="index.php?d=report/paymentByMonth" class="nav-link <?= $mn_paymentByMonthReport ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Payment By Month</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="index.php?d=report/balanceByMonth" class="nav-link <?= $mn_balanceByMonthReport ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Balance By Month</p>
                  </a>
                </li>
              </ul>
            </li>
