<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>TopUp Diary Report</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Report</a></li>
                    <li class="breadcrumb-item active">TopUp Diary Report</li>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <form method="get">
                        <input type="hidden" name="d" value="report/topup" />
                        <div class="row">
                        ...
                        <div class="box-footer">
                            <button type="reset" class="btn btn-default" onclick="document.location='?d=report/topup'">ຍົກເລີກ</button>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="example1" class="table table-bordered beautified_report">
                                        ...
                                        <tbody>
                                            <?php
                                            $arr = topupStaffWalletByDaily($tokenKey, $userName, $_GET['strDate'], $_GET['endDate'], $api_url);
                                            $i = 1;
                                            foreach ($arr as $data) {
                                            ?>
                                                <tr>
